...
wget https://raw.githubusercontent.com/megawatipepek/vip/main/menu.zip
unzip menu.zip
chmod +x *
rm -fr menu.zip
#######service
cd /etc/systemd/system
wget https://raw.githubusercontent.com/megawatipepek/vip/main/service.zip
unzip service.zip
chmod +x *
rm -fr service.zip
#####core
cd /usr/local/bin
wget https://raw.githubusercontent.com/megawatipepek/vip/main/ws.zip
unzip ws.zip
chmod +x *
rm -fr ws.zip
###slowdns
mkdir /etc/slowdns
cd /etc/slowdns
wget https://raw.githubusercontent.com/megawatipepek/vip/main/dns.zip
unzip dns.zip
chmod +x *
...
wget -O /etc/nginx/conf.d/funnvpn.conf https://raw.githubusercontent.com/megawatipepek/vip/main/alif.conf
...
<font color="red"><b>********  Alif VPN  ********</b></font><br>
<font color="blue"><b>===============================</br></font><br>
END
